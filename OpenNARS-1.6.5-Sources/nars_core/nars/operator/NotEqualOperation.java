 ...
 */
public class NotEqualOperation extends NotEqual {
    private Task task;
     ...
     */
    protected NotEqualOperation(Term argProduct, Term operator) {
        super(argProduct, operator);
    }
    
    protected NotEqualOperation(Term[] t) {
        super(t);
    }
     ...
     */
    @Override
    public NotEqualOperation clone() {        
        return new NotEqualOperation(term);
    }
     ...
     */
    public static NotEqualOperation make(final Operator oper, Term[] arg, boolean addSelf) {        
...
//        }
    	...
    	return null;
        //return new NotEqualOperation( new Product(arg), oper  );        
    }
   

    public NotEqualOperation getOperator() {
        return (NotEqualOperation)getPredicate();
    }
    ...
    protected CharSequence makeName() {
        ...
        return makeStatementName(getSubject(), Symbols.NativeOperator.NOTEQUAL, getPredicate());
    }
